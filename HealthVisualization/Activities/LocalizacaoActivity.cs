...
namespace HealthVisualization.Activities
{
    ...
    public class LocalizacaoActivity : AppCompatActivity, IOnMapReadyCallback, Android.Locations.ILocationListener
    {
                ...
                case RequestLocationId:
                    {
                        ...
                        else
                        {
                            ...
                            Toast.MakeText(this, "Não deu boa!", ToastLength.Short).Show(); // TODO: Definir uma nova mensagem toast
                        }
                    }
                    break;
            }
        ...
        private void UpdatePosition()
        {
            ...
            _handler.PostDelayed(_updatePositionAction, 1200); // TODO: Definir um novo intervalo de tempo de atualização da rota
        }
        ...
        private void StartLocationUpdates()
        {
            ...
            _handler.PostDelayed(_updatePositionAction, 1500); // TODO: Definir um novo intervalo de tempo de atualização da rota
        }
        ...
        public void OnLocationChanged(Location location)
        {
            if (location != null && _map != null)
            {
                ...
                _locationTextView.Text = $"Esta é a Latitude: {location.Latitude}, esta é a Longitude: {location.Longitude}"; // TODO: Definir um novo texto do locationTextView
            }
        }
