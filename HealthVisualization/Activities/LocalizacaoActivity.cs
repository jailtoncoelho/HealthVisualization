...
namespace HealthVisualization.Activities
{
    ...
    public class LocalizacaoActivity : AppCompatActivity, IOnMapReadyCallback, Android.Locations.ILocationListener
    {
                ...
                case RequestLocationId:
                    {
                        ...
                        else
                        {
                            ...
                            Toast.MakeText(this, "Não foi possível autorizar sua localização :(", ToastLength.Short).Show(); // TODO: Definir uma nova mensagem toast
                        }
                    }
                    break;
            }
        ...
        private void UpdatePosition()
        {
            ...
            _handler.PostDelayed(_updatePositionAction, 0100); // TODO: Definir um novo intervalo de tempo de atualização da rota
        }
        ...
        public void OnMapReady(GoogleMap googleMap)
        {
            ...
            {
                Toast.MakeText(this, "Seu GPS não está ativo", ToastLength.Short).Show(); // TODO: Definir uma nova mensagem toast
            }
        }
        ...
        public void OnLocationChanged(Location location)
        {
            if (location != null && _map != null)
            {
                ...
                _locationTextView.Text = $"Amplitude: {location.Latitude}, Lonjura: {location.Longitude}"; // TODO: Definir um novo texto do locationTextView
            }
        }
