...
namespace HealthVisualization.Activities
{
    ...
    public class LocalizacaoActivity : AppCompatActivity, IOnMapReadyCallback, Android.Locations.ILocationListener
    {
                ...
                case RequestLocationId:
                    {
                        ...
                        else
                        {
                            ...
                            Toast.MakeText(this, "Não foi permitido encontrar a localização.", ToastLength.Short).Show(); // TODO: Definir uma nova mensagem toast
                        }
                    }
                    break;
            }
        ...
        private void UpdatePosition()
        {
            ...
            _handler.PostDelayed(_updatePositionAction, 800); // TODO: Definir um novo intervalo de tempo de atualização da rota
        }
        ...
        public void OnMapReady(GoogleMap googleMap)
        {
            ...
            {
                Toast.MakeText(this, "ligue seu GPS", ToastLength.Short).Show(); // TODO: Definir uma nova mensagem toast
            }
        }
        ...
        public void OnLocationChanged(Location location)
        {
            if (location != null && _map != null)
            {
                ...
                _locationTextView.Text = $"Amplitude: {location.Latitude}, Distancia: {location.Longitude}"; // TODO: Definir um novo texto do locationTextView
            }
        }
